...
@router.get("/api/stylists/{stylist_id}/availability")
...
@router.put("/api/stylists/{stylist_id}")
def update_stylist(
    stylist_id: int,
...
@router.put("/api/stylists/{stylist_id}/availability")
...
@router.patch("/api/bookings/{booking_id}/assign-stylist")
def assign_stylist(
    booking_id: int,
